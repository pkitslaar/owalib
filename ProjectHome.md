**owalib** is a pure Python library to access (and fetch) e-mail from MS Exchange 2000/2003 servers through Outlook Web Access (OWA) using the WebDAV protocol.
